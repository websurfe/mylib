...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MyLib"
  #coder: need ->terminal -> git tag ‘0.0.1’, git push --tags
  spec.version      = "0.0.1"
  ...
  #                 DESC
  spec.description = "MyLib a test lib"

#coder
  #spec.homepage     = "http://EXAMPLE/MyLib"
  spec.homepage     = "http://facebook.com/MyLib"
 ...
 #coder
  ...
  spec.author             = { "moby" => "motest2000@gmail.com" }
  # Or just: spec.author    = "moby"
  # spec.authors            = { "moby" => "motest2000@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/coder"
